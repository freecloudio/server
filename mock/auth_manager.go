...
// Source: github.com/freecloudio/server/application/manager (interfaces: AuthManager,UserManager)
...
func (m *MockAuthManager) VerifyToken(arg0 models.Token) (*models.Session, *fcerror.Error) {
	m.ctrl.T.Helper()
